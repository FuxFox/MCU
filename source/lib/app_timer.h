...
/** Select the time base that use for app_timer, \ref APP_TIMER_TIMEBASE_TYPE */
#define APP_TIMER_TIMEBASE                     CFG_APP_TIMER_TIMEBASE           
/** the interrupt main-priority of timebase tick */
#define APP_TIMER_TIMEBASE_IRQ_PRIORITY        CFG_APP_TIMEBASE_IRQ_PRIORITY    
/** the max amount of soft timer */
#define APP_TIMER_SOFTTIMER_MAX                CFG_APP_TIMER_NUM_MAX            
...
* @details   stop the hardware timer which app_timer used, all soft timer will pause.
* @param[in] void
* @return    void
*******************************************************************************/
...
* @details   start the hardware timer which app_timer used,
...
* @param[in] app_timer_id_t timer_id : the timer specific to delete, 
*               the id was return by \ref app_timer_create()
* @return    void
*******************************************************************************/
...
* @param[in] void
* @return    void
* @note this function must called in main loop to call the callback function for
...
* @param[in]  void
* @return     void
* @note       you can use hardware timer or RTC as timebase. 
*             timebase must configure as 1ms interrupt,
