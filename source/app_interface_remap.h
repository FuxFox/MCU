...
#define app_gpio_cfg_output(pin)        nrf_gpio_cfg_output(pin)
#define app_gpio_pin_write(pin, state)  nrf_gpio_pin_write(pin, state)
#define app_gpio_pin_read(pin)          nrf_gpio_pin_read(pin)
#define app_gpio_pin_set(pin)           nrf_gpio_pin_set(pin)
#define app_gpio_pin_clear(pin)         nrf_gpio_pin_clear(pin)

#define APP_GPIO_PIN_SET        1
#define APP_GPIO_PIN_RESET      0

#define app_delay_us(us)        nrf_delay_us(us)
